...
<li><a href="https://flangeandfittings.com" target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-white transition">Flanges & Fittings</a></li>
          ...
          <div>
            ...
            <p className="text-gray-300 mt-2">Houston, TX</p>
          </div>
        </div>
