...
export const metadata: Metadata = {
  title: 'Services | Nozzle Flanges',
  description: 'Explore our range of services and products for nozzle flanges.',
};
        ...
        <div className="container-wide">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white border-2 border-blue-200 rounded-lg p-8 hover:shadow-lg transition">
              ...
              <p className="mb-4">
                Complete inventory of nozzle flanges in all standard sizes, materials, and pressure ratings.
